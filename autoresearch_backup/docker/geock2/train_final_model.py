"""Train final Model A on 30 compounds and save"""
import numpy as np
...
model_data = {
    ...
    'n_phys': 60,
    'n_ecfp': 512,
    'performance': {'r': r, 'mae': mae, 'n_samples': len(y)}
}

with open('/mnt/c/Users/yakka/Downloads/final/geock/affinity_model.pkl', 'wb') as f:
    pickle.dump(model_data, f)

print(f"\n{'='*60}")
print(f"FINAL MODEL SAVED")
print(f"{'='*60}")
print(f"Performance (5-fold CV on 30 compounds):")
print(f"  Pearson R: {r:.4f}")
print(f"  MAE: {mae:.4f} kcal/mol")
print(f"Features: {X_hybrid.shape[1]} (60 physics + 512 ECFP)")
print(f"Saved to: affinity_model.pkl")
print(f"{'='*60}")
